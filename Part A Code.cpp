...
// List of commonly used PINs took from research---- https://timesofindia.indiatimes.com/technology/tech-tips/10-most-and-least-common-4-digit-pins-is-yours-among-them/articleshow/110277989.cms
...
int main() {
    ...
    if (!isValidPIN(pin)) {
        cout << " That doesn't look like a valid PIN." << endl;
        return 1;
    }
